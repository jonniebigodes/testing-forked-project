...
/**
 * This component is a simple accordion that allows users to expand and collapse sections of content. It accepts an array of items, each with a title and content. The `inverted` prop can be used to switch the color scheme for better contrast in dark mode. The component manages its own state to track which items are open, and it provides accessible attributes for screen readers.
 */
